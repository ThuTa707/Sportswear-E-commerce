            ...
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown messages-menu">
                    <a href="#" class="dropdown-toggle admin-notification" data-toggle="dropdown">
                        ...
                        <span
                            class="label label-danger">{{ App\Order::where('order_status', 'New')->get()->count() }}</span>
                    </a>
                        ...
                        <li>
                            <ul class="menu">
                                @foreach ($new_orders as $order)
                                    ...
                                    <li>
                                        ...
                                        <a href="#" class="border-gray">
                                            <div class="pull-left">
                                                <img src="{{ asset('backend/assets/dist/img/basketball-jersey.png') }}"
                                                    class="img-thumbnail" alt="User Image">
                                            </div>

                                            <h4>{{ $order->shipping_name }}</h4>

                                            @php
                                                $total_quantity = 0;
                                                foreach ($order->orderProducts as $pro) {
                                                    $total_quantity = $total_quantity + $pro->product_quantity;
                                                }
                                            @endphp
                                          
                                            <p><strong>total quantity: {{ $total_quantity }} </strong>
                                            </p>
                                ...
                                {{-- <li>
                                    <a href="#" class="border-gray">
                                        <div class="pull-left">
                                            <img src="{{ asset('backend/assets/dist/img/shirt.png') }}"
                                                class="img-thumbnail" alt="User Image">
                                        </div>
                                        <h4>Kits</h4>
                                ...
                                <li>
                                    <a href="#" class="border-gray">
                                        <div class="pull-left">
                                            <img src="{{ asset('backend/assets/dist/img/football.png') }}"
                                                class="img-thumbnail" alt="User Image">
                                        </div>
                                        <h4>Football</h4>
                                ...
                                <li class="nav-list">
                                    <a href="#" class="border-gray">
                                        <div class="pull-left">
                                            <img src="{{ asset('backend/assets/dist/img/shoe.png') }}"
                                                class="img-thumbnail" alt="User Image">
                                        </div>
                                        <h4>Sports sheos</h4>
                        ...
                        <li>
                            <ul class="menu">
                                ...
                                <li>
                                    <a href="#" class="border-gray">
                                        <div class="pull-left">
                                            <img src="{{ asset('backend/assets/dist/img/avatar5.png') }}"
                                                class="img-circle" alt="User Image">
                                        </div>
                                        <h4>Sergio Ramos</h4>
